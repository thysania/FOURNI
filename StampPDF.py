...
def add_stamp_to_pdf(input_pdf_path, output_pdf_path, stamp_image_path, a4_position, a5_landscape_position):
    """
    ...
    # A5 landscape: 420 x 595 points (14.8 x 21.0 cm)
    ...
    rect = fitz.Rect(position[0], position[1], position[0] + 100, position[1] + 50)  # Adjust size as needed
...
if __name__ == "__main__":
    ...
    for pdf_file in pdf_files:
        ...
        try:
            add_stamp_to_pdf(pdf_file, output_pdf, stamp_image, a4_position, a5_landscape_position)
